...
<template>
  <div class="timeline-container right" v-motion-slide-visible-left :delay="(props.item * 10) + 500" :duration="1000">
      <div class="timeline-content">
          <h4 v-motion-fade-visible-once>{{ props.item.year }}</h4>
          <p v-motion-fade-visible-once>{{ props.item.event }}</p>
      </div>
  </div>
</template>
